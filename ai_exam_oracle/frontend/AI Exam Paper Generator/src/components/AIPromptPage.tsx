...
export function AIPromptPage() {
    ...
    return (
        ...
        <div className="absolute inset-0 bg-[#0A2F2F]/95 backdrop-blur-sm z-[100] flex items-center justify-center p-6 pt-20 pb-24">
            ...
            >
                {/* Main Container */}
                <div className="bg-gradient-to-br from-[#F5F1ED] to-[#E5DED6] rounded-[40px] p-6 border-4 border-[#E5DED6] relative overflow-hidden shadow-2xl">
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.9 }}
                        onClick={handleClose}
                        className="absolute top-4 right-4 w-10 h-10 bg-[#0D2626] rounded-xl flex items-center justify-center z-20 shadow-md cursor-pointer"
                    >
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {promptSuggestions.slice(0, 3).map((suggestion, index) => (
                                        <motion.button
                                            ...
                                            className="px-3 py-2 rounded-xl text-xs font-semibold border-2 text-[#0A1F1F] cursor-pointer"
                                            style={{
                    ...
                    <div className="mb-4 relative z-10">
                        <div className="relative">
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.9 }}
                                className="absolute top-3 right-3 w-8 h-8 bg-gradient-to-br from-[#FFB86C] to-[#FF6AC1] rounded-xl flex items-center justify-center z-20 shadow-lg pointer-events-none"
                            >
                    ...
                    <div className="grid grid-cols-3 gap-3 mb-4 relative z-10">
                        <motion.button
                            whileHover={{ scale: 1.05, y: -2 }}
                            whileTap={{ scale: 0.95 }}
                            className="py-3 rounded-2xl bg-gradient-to-br from-[#8BE9FD] to-[#6FEDD6] border-4 border-white/30 flex items-center justify-center gap-2 cursor-pointer"
                        >
                        ...
                        <motion.button
                            ...
                            className="py-3 rounded-2xl bg-gradient-to-br from-[#F1FA8C] to-[#50FA7B] border-4 border-white/30 flex items-center justify-center gap-2 cursor-pointer"
                        >
                        ...
                        <motion.button
                            whileHover={{ scale: 1.05, y: -2 }}
                            whileTap={{ scale: 0.95 }}
                            className="py-3 rounded-2xl bg-gradient-to-br from-[#FFB86C] to-[#FF6AC1] border-4 border-white/30 flex items-center justify-center gap-2 cursor-pointer"
                        >
                    ...
                    <motion.button
                        ...
                        className={`w-full py-5 rounded-[28px] font-bold text-lg flex items-center justify-center gap-3 border-4 relative overflow-hidden transition-all cursor-pointer ${prompt.trim() && !isGenerating
