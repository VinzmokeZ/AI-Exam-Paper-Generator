...
export function TodaysGoals() {
  ...
  return (
    <div className="min-h-full pb-6">
      ...
      <div className="absolute bottom-40 right-10 w-36 h-36 bg-[#8BE9FD]/10 rounded-full blur-3xl float-slow float-delay-1" />
          ...
          {goals.map((goal, index) => (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className={`text-sm font-medium ${goal.completed ? 'text-[#8B9E9E] line-through' : 'text-[#F5F1ED]'
                    }`}>
                    {goal.text}
                  </p>
                </div>
